...
@interface MainViewController : UIViewController <SettingsManagerDelegate, FPSDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate,RevMobAdsDelegate> {
	/* Painting view */
