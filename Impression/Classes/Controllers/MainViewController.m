...
- (void) pressedSaveButton:(UIButton*)sender {
	...
	if (sender == _saveToClip) {
		...
		[composer setInitialText:@"Created with the Impressionism style photo iOS app! https://itunes.apple.com/us/app/insangjuui-hoehwa-sajin-hyogwa/id961317138?mt=8"];
		...
		documentInteractionController.annotation = [NSDictionary dictionaryWithObject:@"Created with the Impressionism style photo iOS app! https://itunes.apple.com/us/app/insangjuui-hoehwa-sajin-hyogwa/id961317138?mt=8" forKey:@"InstagramCaption"];
